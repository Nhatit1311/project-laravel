...
<html class="no-js" lang="">
    ...
    <body>
        ...
        <main>
            ...
            <!-- banner-area -->
            <section class="banner-area banner-bg" data-background="/assets_client/img/banner/banner_bg01.jpg">
                <div class="container custom-container">
                    <div class="row">
            ...
            <section class="ucm-area ucm-bg" data-background="/assets_client/img/bg/ucm_bg.jpg">
                <div class="ucm-bg-shape" data-background="/assets_client/img/bg/ucm_bg_shape.png"></div>
                <div class="container">
                    ...
                    <div class="tab-content" id="myTabContent">
                            ...
                            <div class="ucm-active owl-carousel">
                                <div class="movie-item mb-50">
                                    <div class="movie-poster">
                                        <a href="movie-details.html"><img src="/assets_client/img/poster/ucm_poster01.jpg" alt=""></a>
                                    </div>
                                ...
                                <div class="movie-item mb-50">
                                    <div class="movie-poster">
                                        <a href="movie-details.html"><img src="/assets_client/img/poster/ucm_poster02.jpg" alt=""></a>
                                    </div>
                                    <div class="movie-content">
                                        <div class="top">
                                ...
                                <div class="movie-item mb-50">
                                    <div class="movie-poster">
                                        <a href="movie-details.html"><img src="/assets_client/img/poster/ucm_poster05.jpg" alt=""></a>
                                    </div>
                                    <div class="movie-content">
                                        <div class="top">
                        ...
                        <div class="tab-pane fade" id="movies" role="tabpanel" aria-labelledby="movies-tab">
                            <div class="ucm-active owl-carousel">
                                ...
                                <div class="movie-item mb-50">
                                    <div class="movie-poster">
                                        <a href="movie-details.html"><img src="/assets_client/img/poster/ucm_poster06.jpg" alt=""></a>
                                    </div>
                                    <div class="movie-content">
                                        <div class="top">
                                ...
                                <div class="movie-item mb-50">
                                    <div class="movie-poster">
                                        <a href="movie-details.html"><img src="/assets_client/img/poster/ucm_poster07.jpg" alt=""></a>
                                    </div>
                                    <div class="movie-content">
                                        <div class="top">
                                ...
                                <div class="movie-item mb-50">
                                    <div class="movie-poster">
                                        <a href="movie-details.html"><img src="/assets_client/img/poster/ucm_poster08.jpg" alt=""></a>
                                    </div>
                                    <div class="movie-content">
                                        <div class="top">
            ...
            <!-- services-area -->
            <section class="services-area services-bg" data-background="/assets_client/img/bg/services_bg.jpg">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="services-img-wrap">
                                <img src="/assets_client/img/images/services_img.jpg" alt="">
                                <a href="/assets_client/img/images/services_img.jpg" class="download-btn" download>Download <img src="fonts/download.svg" alt=""></a>
                            </div>
                        </div>
                        <div class="col-lg-6">
            ...
            <!-- top-rated-movie -->
            <section class="top-rated-movie tr-movie-bg" data-background="/assets_client/img/bg/tr_movies_bg.jpg">
                <div class="container">
            ...
            <!-- live-area -->
            <section class="live-area live-bg fix" data-background="/assets_client/img/bg/live_bg.jpg">
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-7 col-lg-6">
                            <div class="live-movie-img wow fadeInRight" data-wow-delay=".2s" data-wow-duration="1.8s">
                                <img src="/assets_client/img/images/live_img.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- tv-series-area -->
            <section class="tv-series-area tv-series-bg" data-background="/assets_client/img/bg/tv_series_bg.jpg">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="section-title text-center mb-50">
